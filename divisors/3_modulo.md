...
105. For any modulus $m$, one can get all of the elements in $\mathbb{Z}_m$ from repeated addition by 1, or, more generally, a class which is relatively prime to $m.$
